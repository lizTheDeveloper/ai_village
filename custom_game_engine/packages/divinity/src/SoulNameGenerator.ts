...
export class SoulNameGenerator {
  ...
  private namePools: Record<SoulCulture, string[]> = {
    ...
    elven: [
      ...
      'Eldrin', 'Aerendyl', 'Elowen', 'Saelethil', 'Vardamir', 'Iluvia',
      'Orelindë', 'Talanis', 'Caelura', 'Velithra', 'Aeloria', 'Selenith',
      'Lunarael', 'Velorien', 'Ithilra', 'Aurafel', 'Solivaen', 'Taelindë',
      'Aethindë', 'Choralith', 'Velindrae', 'Luminael', 'Solanthe', 'Aelvari',
      'Chorusiel', 'Stellindra', 'Resonael', 'Harmoniel', 'Celesthra', 'Aurindë',
      'Phaseline', 'Solindael', 'Frequenthë',
    ],
    dwarven: [
      'Brokkr', 'Durgan', 'Haldrek', 'Grindal', 'Volmur', 'Thorvak', 'Rundis', 'Skarn',
      'Beldrak', 'Korgrim', 'Anvald', 'Stonegrund', 'Forgrim', 'Irnak', 'Halverd', 'Drukk',
      'Moldren', 'Galdrak', 'Torgrund', 'Bolkrem', 'Rundak', 'Kragven', 'Stalgrin', 'Halmek',
      'Drenvar', 'Bolvak', 'Grindrek', 'Skaldren', 'Valdrim', 'Thordak', 'Grundek', 'Halmvar',
      'Kolvren', 'Stormak', 'Anvrek', 'Forgund', 'Drenmak', 'Bolgrund', 'Skarvek', 'Halmgrund',
    ],
    orcish: [
      'Grukk', 'Tharg', 'Vrakk', 'Skurg', 'Drukk', 'Moldak', 'Gharn', 'Krozz',
      'Brakk', 'Vurg', 'Thodak', 'Krenn', 'Skrag', 'Drokk', 'Ghulk', 'Raddak',
      'Skarth', 'Kruk', 'Grublik', 'Rendak', 'Gholvek', 'Brukken', 'Thordrek', 'Kragmul',
      'Thrak', 'Drevnak', 'Varsh', 'Skolgrin', 'Zorug', 'Varnkek', 'Grudmol', 'Harkven',
      'Thokmak', 'Krakgor', 'Skrekk', 'Dravven', 'Grolvak', 'Thorndul', 'Krendak', 'Skarvul',
    ],
    thrakeen: [
  ...
  private async generateLLMName(culture: SoulCulture, retryAttempt: number = 0): Promise<string> {
    ...
    const culturalDescriptions: Record<SoulCulture, string> = {
      ...
      dwarven: 'Strong, stone-like dwarven names (e.g., Brokkr, Durgan, Haldrek)',
      orcish: 'Harsh, guttural orcish names (e.g., Grukk, Tharg, Vrakk)',
