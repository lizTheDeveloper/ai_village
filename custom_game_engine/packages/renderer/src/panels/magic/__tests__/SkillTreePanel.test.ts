...
describe('SkillTreePanel', () => {
  ...
  let panel: any; // SkillTreePanel - doesn't exist yet
  ...
  describe('Criterion 2: Node States', () => {
    ...
    it('should display available nodes with yellow glow', () => {
      ...
      const yellowStrokes = ctx.strokeStyle.mock.calls?.filter((call: any) =>
    ...
    it('should display locked nodes with gray background', () => {
      ...
      const grayFills = ctx.fillStyle.mock.calls?.filter((call: any) =>
