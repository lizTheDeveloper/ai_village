...
export const CLARKETECH_RESEARCH: ResearchDefinition[] = [
  ...
  {
    id: 'exotic_physics_iii',
    name: 'Exotic Physics III',
    description:
      'Transcendent dimensional architecture. Build structures that exist in five or more spatial dimensions. Your buildings now have addresses that require imaginary numbers and a philosophical degree to understand.',
    field: CLARKETECH_FIELD,
    tier: 8,
    progressRequired: 350000,
    prerequisites: ['pocket_dimension_mastery', 'stable_inter_multiverse_portals'],
    requiredBuilding: 'inter_multiverse_portal',
    unlocks: [
      { type: 'building', buildingId: 'penteract_building' },
      { type: 'research', researchId: 'universe_bridging' },
      { type: 'knowledge', knowledgeId: 'transcendent_geometry' },
    ],
    type: 'predefined',
  },
  {
    id: 'universe_bridging',
    name: 'Universe Bridging',
    description:
      'Create permanent structural connections between universes. Your building exists simultaneously in multiple realities, serving as a bridge between worlds. Doorways lead to alternate timelines. Rent is collected in fourteen currencies across five dimensions.',
    field: CLARKETECH_FIELD,
    tier: 8,
    progressRequired: 400000,
    prerequisites: ['exotic_physics_iii'],
    requiredBuilding: 'penteract_building',
    unlocks: [
