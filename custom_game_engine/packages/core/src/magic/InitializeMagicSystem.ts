...
function registerExampleSpells(): void {
  ...
  const exampleSpells: SpellDefinition[] = [
    ...
    // =========================================================================
    {
      ...
      description: 'Channel divine power to heal wounds.',
      school: 'restoration',
    ...
    },
    {
      ...
      description: 'Bestow divine protection upon a target.',
      school: 'protection',
    ...
    },
    {
      ...
      description: 'Call down divine wrath upon an enemy.',
      school: 'smiting',
    ...
    },
    {
      ...
      description: 'Grant ongoing divine healing over time.',
      school: 'restoration',
    ...
    },
    {
      ...
      description: 'Create a powerful divine shield around yourself.',
      school: 'protection',
