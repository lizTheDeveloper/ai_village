...
export const UNIVERSAL_TACTICS: CourtshipTactic[] = [
  {
    id: 'conversation',
    name: 'Conversation',
  ...
  },
  {
    ...
    category: 'activity',
    requirements: { proximity: 5, time: 600 },
    visibleToOthers: true,
    description: 'Do an activity together',
    baseAppeal: 0.4,
    appealModifiers: {
      personality: {
        active: 0.4,
  ...
  },
  {
    ...
    name: 'Make Laugh',
    category: 'conversation',
    requirements: { proximity: 3, time: 100 },
    visibleToOthers: true,
    description: 'Share jokes and laughter',
    baseAppeal: 0.5,
    appealModifiers: {
      personality: {
        playful: 0.6,
...
// ============================================================================
// Dwarf-Specific Tactics
// ============================================================================

export const DWARF_TACTICS: CourtshipTactic[] = [
  {
    id: 'craft_gift',
  ...
  },
  {
    ...
    visibleToOthers: true,
    description: 'Build or craft something together',
    baseAppeal: 0.75,
    appealModifiers: {
      personality: {
        collaborative: 0.6,
  ...
  },
  {
    ...
    visibleToOthers: true,
    description: 'Show financial security',
    baseAppeal: 0.5,
    appealModifiers: {
      personality: {
        pragmatic: 0.6,
  ...
  },
  {
    ...
    visibleToOthers: true,
    description: 'Share family history and tales',
    baseAppeal: 0.6,
    appealModifiers: {
      personality: {
        traditional: 0.7,
...
export const BIRD_FOLK_TACTICS: CourtshipTactic[] = [
  {
    id: 'aerial_dance',
    name: 'Aerial Dance',
    category: 'display',
...
export const MYSTIF_TACTICS: CourtshipTactic[] = [
  {
    id: 'mind_touch',
    name: 'Mind Touch',
    category: 'magic',
  ...
  },
  {
    ...
    visibleToOthers: true,
    description: 'Teach or share magical knowledge',
    baseAppeal: 0.75,
    appealModifiers: {
      personality: {
        curious: 0.6,
...
// ============================================================================
// Negative Tactics (Generally Disliked)
// ============================================================================

export const NEGATIVE_TACTICS: CourtshipTactic[] = [
  {
  ...
  },
  {
    ...
    name: 'Combat Display',
    category: 'dominance',
    requirements: { proximity: 5, time: 400, energy: 25 },
    visibleToOthers: true,
    description: 'Fight to prove dominance',
    baseAppeal: -0.4,
    appealModifiers: {
      personality: {
        pacifist: -1.0,
  ...
  },
  {
    ...
    requirements: { proximity: 1, time: 50 },
    visibleToOthers: true,
    description: 'Rush intimacy too quickly',
    baseAppeal: -0.3,
    appealModifiers: {
      personality: {
        cautious: -0.6,
