...
/**
 * Divine Magic → β-Space
 *
 * Via Divine Ascension:
 * - Attain divinity and transcend normal spacetime
 * - Receive divine grants of dimensional travel
 * - Navigate via faith and divine will
 *
 * Requires massive worship infrastructure and divine favor.
 */
export const DIVINE_ASCENSION_TRAVEL_SET: ResearchSet = {
  ...
  allPapers: [
    ...
    'divine_granted_ship_construction',
    'celestial_fleet_creation'
  ],

  unlocks: [
    {
      technologyId: 'divine_spark',
      papersRequired: 5, // Need 5 of 17
      mandatoryPapers: ['apotheosis_theory', 'divine_spark_cultivation', 'worship_power_mechanics'],
      grants: [
        { type: 'building', buildingId: 'temple_complex' },
        { type: 'ability', abilityId: 'gather_faith_energy' }
      ]
    },
    {
      technologyId: 'divine_ascension',
      papersRequired: 10, // Need 10 of 17
      mandatoryPapers: ['divine_ascension_rituals', 'omnipresence_fundamentals', 'celestial_navigation'],
      grants: [
        { type: 'ability', abilityId: 'achieve_divinity' },
        { type: 'building', buildingId: 'divine_chariot_ship' }, // Divine β-space ship
        { type: 'ability', abilityId: 'celestial_travel' }
      ]
    },
    {
      technologyId: 'multiverse_divinity',
      papersRequired: 14, // Need 14 of 17
      mandatoryPapers: ['divine_multiverse_awareness', 'divine_beta_space_correspondence', 'faith_quantum_coupling'],
      grants: [
        { type: 'ability', abilityId: 'divine_beta_navigation' },
        { type: 'ability', abilityId: 'omnipresent_timeline_awareness' }
      ]
    }
  ]
};
