...
†Professor Emeritus Quaternion of the The Invisible College's Department of Applied Folding describes this phenomenon as "the architectural equivalent of getting a new puppy—tremendous enthusiasm for the first week, followed by the gradual realization that someone has to clean up the inevitable mess."
...
The psychological toll of prolonged rift maintenance deserves particular attention, as evidenced by the condition now clinically recognized as "Void-Facing Fatigue"†††. Maintenance technicians report a peculiar phenomenon: the longer one stares into a dimensional rift, the more one becomes aware that something is staring back—and taking notes‡. The famous case of Senior Technician Herbert Woolsworth epitomizes this hazard. After two years of maintaining an unusually stable rift in the basement of the The Invisible College's Department of Unnecessary Physics, Woolsworth submitted a seventeen-page report in which he insisted that the entities on the far side had shown him "the true nature of Thursday" and that he could "no longer in good conscience participate in Fridays"‡‡. Though he eventually recovered after a mandatory six-month sabbatical at the Institute for the Contemplation of Normal Things, he now insists on referring to weekdays by number only and has developed an unshakable conviction that February is "structurally suspect"‡‡‡.
...
† The theological implications are examined in Reverend-Doctor Callista Smallgod's "Deity, Divinity, or Just Really Determined: A Taxonomy of Creation." Smallgod argues that the distinction between "god" and "person who made a universe" is largely semantic and depends primarily on whether one requires worship or just really appreciates it when the pocket dimension's inhabitants acknowledge one's existence. The book was banned in seventeen jurisdictions for being "theologically uncomfortable" but remains required reading at the The Invisible College.
