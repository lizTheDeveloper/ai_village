# ai_village - Project Conventions
...
ai_village is a reusable multi-agent orchestration toolkit for autonomous SDLC automation. Extracted from the Super Alignment to Utopia research simulation project.
